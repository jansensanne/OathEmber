 ...
 * This file demonstrates how to integrate Oathember with a web frontend
 */

// For React/Vue/Angular applications
export class OathemberClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new OathemberClient(provider, contractAddress);
